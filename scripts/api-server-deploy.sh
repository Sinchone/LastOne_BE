...
nohup java -jar -Dserver.port=${TARGET_PORT} ${JAR_FILE} > /home/ubuntu/app/api_log.out 2>&1 &
...
echo "set \$api_service_url http://3.38.5.26:${TARGET_PORT};" | sudo tee /etc/nginx/conf.d/api_service_url.inc
